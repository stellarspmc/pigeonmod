...
public class WoodPigeonEntity extends PigeonEntity {
    ...
    public @Nullable AgeableMob getBreedOffspring(@NotNull ServerLevel serverWorld, @NotNull AgeableMob ageableMob) {
        PigeonEntity entity = (PigeonsModEntities.WOOD_PIGEON.get()).create(serverWorld);
        assert entity != null;
    ...
    public SoundEvent getAmbientSound() {
        return !this.isBaby() ? BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("pigeons:wood_pigeon_sound")) : BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("pigeons:chick_sound"));
    }
}
