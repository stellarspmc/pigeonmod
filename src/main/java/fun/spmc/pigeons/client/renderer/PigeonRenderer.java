...
public class PigeonRenderer extends MobRenderer<AbstractPigeonEntity, PigeonModel<AbstractPigeonEntity>> {
    private final PigeonChildModel<AbstractPigeonEntity> baby;

    private final PigeonModel<AbstractPigeonEntity> adult = this.getModel();
    ...
    @Override
    protected void scale(AbstractPigeonEntity entity, @NotNull PoseStack poseStack, float f) {
    ...
    @Override
    public void render(@NotNull AbstractPigeonEntity entity, float p_115309_, float p_115310_, @NotNull PoseStack p_115311_, @NotNull MultiBufferSource p_115312_, int p_115313_) {
