...
public class KereruChildModel<T extends Entity> extends PigeonModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("pigeons", "model_kereru_baby"), "main");

    public KereruChildModel(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        RWing.addOrReplaceChild("RWing_r1", CubeListBuilder.create().texOffs(1, 16).addBox(-0.5F, -0.1752F, -0.1002F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.4F, 0.0F, 0.0F, -0.2182F, 0.0F, 0.0F));
        PartDefinition LWing = All.addOrReplaceChild("LWing", CubeListBuilder.create(), PartPose.offset(2.5F, -4.6F, -0.7F));
        LWing.addOrReplaceChild("LWing_r1", CubeListBuilder.create().texOffs(17, 16).addBox(-0.5F, -0.1752F, -0.1002F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4F, 0.1F, 0.0F, -0.2182F, 0.0F, 0.0F));
        ...
        All.addOrReplaceChild("HeadBeak", CubeListBuilder.create().texOffs(12, 26).addBox(-1.55F, -7.6554F, -1.8675F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(28, 0).addBox(-0.6F, -6.4F, -3.8F, 1.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, -0.4F));
