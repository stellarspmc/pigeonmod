...
public class ArchangelPigeonModel<T extends Entity> extends PigeonModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("pigeons", "model_archangel_pigeon"), "main");

    public ArchangelPigeonModel(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        RLeg.addOrReplaceChild("RLeg1_r1", CubeListBuilder.create().texOffs(20, 7).addBox(-0.5F, -1.5F, 0.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.95F, -1.55F, -1.5708F, 0.0F, 0.0F));
        ...
        LLeg.addOrReplaceChild("LLeg1_r1", CubeListBuilder.create().texOffs(20, 8).addBox(-0.5F, -1.5F, 0.0F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1F, 2.0F, -1.5F, -1.5708F, 0.0F, 0.0F));
        All.addOrReplaceChild("HeadBeak", CubeListBuilder.create().texOffs(18, 0).addBox(-1.05F, -4.6554F, -0.8675F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(12, 18).addBox(-0.6F, -4.15F, -1.8F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(18, 7).addBox(0.0F, -5.25F, 0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.0F, -1.4F));
