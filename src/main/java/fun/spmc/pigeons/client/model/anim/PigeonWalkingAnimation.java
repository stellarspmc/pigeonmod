...
public class PigeonWalkingAnimation {
    public static final AnimationDefinition WALKING;

    static {
        WALKING = AnimationDefinition.Builder.withLength(0.625F).looping()
                ...
                .addAnimation("LLeg", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(0.625F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR))).build();
    }
}
